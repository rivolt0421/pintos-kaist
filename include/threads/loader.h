...
#define SEL_KCSEG       0x08    /* Kernel code selector.  octal : 010 */
#define SEL_KDSEG       0x10    /* Kernel data selector.  octal : 020 */
#define SEL_UDSEG       0x1B    /* User data selector.    octal : 033 */
#define SEL_UCSEG       0x23    /* User code selector.    octal : 043 */
